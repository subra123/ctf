...
# Shiva consonants starting from VA
# VA KA PA YA SHA SSA SA RA HA LA
shiva_crib = bytes([0xDC, 0xB3, 0xD4, 0xDF, 0xE6, 0xE7, 0xED, 0xE2, 0xEF, 0xEB])

K = xor(c_bytes[2][:len(shiva_crib)], shiva_crib)

p4 = xor(c_bytes[4][:len(K)], K)
print(f"p4: {p4}")
p1 = xor(c_bytes[1][:len(K)], K)
print(f"p1: {p1}")
